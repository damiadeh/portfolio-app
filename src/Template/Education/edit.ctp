...
<div class="container form-group">
   <?= $this->Html->link(__('Back'), ['action' => 'index'], ['class' => 'btn btn-primary']) ?>
    ...
    <fieldset>
        ...
        <?php
            echo $this->Form->control(('school_name'), ['class' => 'form-control']);
            echo $this->Form->control(('sch_duration'), ['class' => 'form-control']);
            echo $this->Form->control(('sch_description'), ['class' => 'form-control']);
        ?>
    </fieldset>
